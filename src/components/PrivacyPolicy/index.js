...
const PrivacyPolicy = () => (
  <div className="privacy-policy">
    ...
    <p>
      Le site web O'My Plant est détenu par O'My Plant, qui est un contrôleur de
      données de vos données personnelles.
    </p>
    <p>
      Nous avons adopté cette politique de confidentialité, qui détermine la
      manière dont nous traitons les informations collectées par O'My Plant, qui
      fournit également les raisons pour lesquelles nous devons collecter
      certaines données personnelles vous concernant. Par conséquent, vous devez
      lire cette politique de confidentialité avant d'utiliser le site web de
      O'My Plant.
    </p>
    <p>
      Nous prenons soin de vos données personnelles et nous nous engageons à en
      garantir la confidentialité et la sécurité.
    </p>
    <h4>Les informations personnelles que nous collectons :</h4>
    <p>
      Lorsque vous visitez le O'My Plant, nous recueillons automatiquement
    ...
    <p>
      ...
      pouvez envoyer un courriel à oomyplant@gmail.com.
    </p>
  </div>
);
